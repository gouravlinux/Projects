"""
Django settings for e_chayan_project project.
...
ROOT_URLCONF = "e_chayan_project.urls"
...
WSGI_APPLICATION = "e_chayan_project.wsgi.application"
...
# If we are on Render, override with the Postgres configuration
...
# EMAIL CONFIGURATION (Using Anymail / API)
